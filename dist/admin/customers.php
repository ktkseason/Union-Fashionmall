...
<body>
    ...
    <main>
        <section class="admin-checkouts container">
            ...
            ?>
                    <h1><?= $customer->name ?> / <span><?= $customer->email ?></span>
                    </h1>
                        ...
                        ?>
                            <div class="checkout">
                                <div class="checkout-head">
                                    ...
                                    <a class="update" href="../_actions/_admin/update-checkout.php?id=<?= $checkout->id ?>"><i class="fa-solid fa-circle-check <?php if ($checkout->status) echo 'shipped';
