        ...
        <section class="container">
            ...
            <div class="stock-head">
                ...
                <div class="add-update-btns">
                    <a href="stock-edit.php?gender=<?= $gender_id ?>&topic=<?= $topic_id ?>"
            ...
            <table class="container">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="../_actions/_admin/delete-stock.php?gender=<?= $gender_id ?>&topic=<?= $topic_id ?>&id=<?= $product->id ?>"
                                class="btn btn-text">Delete</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
