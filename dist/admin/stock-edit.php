            ...
            <section class="admin-stocks">
                ...
                <div class="stocks-product">
                    <div class="product-head">
                        ...
                        <a
                            href="../_actions/_admin/delete-stock.php?gender=<?= $gender_id ?>&topic=<?= $topic_id ?>&id=<?= $product->id ?>"><i
                    ...
                    <div class="img-container">
                        ...
                        <div class="img">
                            ...
                            <a
                                href="../_actions/_admin/manage-image.php?gender=<?= $gender_id ?>&topic=<?= $topic_id ?>&id=<?= $image->image_id ?>&del=1"><i
                            ...
                            <div class="with-header editables">
                                ...
                                <div class="sizes">
                                    ...
                                    <div class="size">
                                        ...
                                        <input type="number" id="<?= $size->name ?>" name="<?= $size->id ?>"
                                            class="stockNo" min=0
                                            value=<?php
