        ...
        <div class="img-showcase">
            ...
            <div class="img-view">
                ...
                <img src="../assets/img/<?= $image->image ?>"
                    class="img-<?= $image->image_id ?> <?php if ($images[0]->image == $image->image) echo "active"; ?>"
                    alt="">
                <?php endforeach; ?>
            </div>
            <div class="thumbnail-holder">
                <?php foreach ($images as $image) : ?>
                <div
                    class="img-thumbnail <?php if ($images[0]->image == $image->image) echo "active"; ?> img-<?= $image->image_id ?>">
            ...
            <form action="../_actions/add-to-bag.php" method="post">
                ...
                <div class="inputs">
                    ...
                    <div class="input">
                        ...
                        <input type="number" min="0" name="quantity_<?= $size_stock->id ?>"
                            max="<?= $size_stock->stock ?>" id="<?= $size_stock->id ?>" value=0 required>
                    </div>
                    <?php endforeach; ?>
                </div>
                <div class="btns">
        ...
        <div class="card-container">
            ...
            <div class="card">
                <div class="img-holder">
                    <a href="product-detail.php?id=<?= $similar->id ?>"><img
                            src="../assets/img/<?php $images = $data->getImageByProduct($similar->id);
