    ...
    <div class="filter-container">
                ...
                <div class="filter-dropdown">
                    ...
                    <div class="dropdown">
                        <?php foreach ($brands as $brand) : ?>
                            <div>
                                <a href="products.php?gender=<?= $gender_id ?>&topic=<?= $topic_id ?>&brand=<?= $brand->id ?>" style="text-decoration:<?php if ($brand_id == $brand->id) echo "line-through" ?>;"><?= $brand->name ?></a>
                            </div>
                        <?php endforeach; ?>
                    </div>
                </div>
                    ...
                    <div class="dropdown">
                        <?php foreach ($colors as $color) : ?>
                            <div>
                                ...
                                <a href="products.php?gender=<?= $gender_id ?>&topic=<?= $topic_id ?>&color=<?= $color->id ?>" style="text-decoration:<?php if ($color_id == $color->id) echo "line-through" ?>;"><?= $color->name ?></a>
                            </div>
                        <?php endforeach; ?>
                    </div>
                </div>
        ...
        <div class="product-filter">
            <div class="filter-dropdown sort">
                ...
                <div class="dropdown">
                    <div>
                        <a href="products.php?gender=<?= $gender_id ?>&topic=<?= $topic_id ?>&category=<?= $category_id ?>&brand=<?= $brand_id ?>&color=<?= $color_id ?>&latest=1" style="text-decoration:<?php if ($latest) echo "line-through" ?>;">Latest
                            First</a>
                    </div>
                    <div>
                        <a href="products.php?gender=<?= $gender_id ?>&topic=<?= $topic_id ?>&category=<?= $category_id ?>&brand=<?= $brand_id ?>&color=<?= $color_id ?>&highfirst=1" style="text-decoration:<?php if ($highfirst) echo "line-through" ?>;">High
                            Price First</a>
                    </div>
                    <div>
                        <a href="products.php?gender=<?= $gender_id ?>&topic=<?= $topic_id ?>&category=<?= $category_id ?>&brand=<?= $brand_id ?>&color=<?= $color_id ?>&lowfirst=1" style="text-decoration:<?php if ($lowfirst) echo "line-through" ?>;">Low
                            Price First</a>
                    </div>
                </div>
            </div>
